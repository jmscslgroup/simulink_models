  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"set_point_adapter\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(set_point_adapter_M, (NULL));
        set_point_adapter_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(set_point_adapter_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(set_point_adapter_M)
                == (NULL)) || rtmGetStopRequested(set_point_adapter_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(set_point_adapter_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
